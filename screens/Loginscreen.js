       ...
       {/* <Image className="h-full w-full absolute" source={require('../assets/background.jpeg')}/> */}
        <View className="h-full w-full flex justify-around pt-40 pb-10">
            ...
            <View className="flex items-center mx-4 space-y-4 ">
                ...
                <TouchableOpacity onPress={()=> navigation.push('Logindashboard')} className="w-full bg-black p-3 rounded-2xl mb-3">
                    <Text className="text-xl font-bold text-white text-center">Continue</Text>
                    </TouchableOpacity>
                </View>
                <View className="w-full">
                <TouchableOpacity className="w-full bg-black/5 p-3 rounded-2xl mb-3">
                    <Text className="text-xl font-bold text-black text-center"><Icon name="google" size={28} /> Continue with Google</Text>
                    </TouchableOpacity>
                </View>
                <View className="w-full">
                <TouchableOpacity className="w-full bg-black/5 p-3 rounded-2xl mb-3">
                    <Text className="text-xl font-bold text-black text-center"><Icon name="facebook" color="black" size={28} /> Continue with Facebook</Text>
                    </TouchableOpacity>
                </View>
                <View className="w-full">
                <TouchableOpacity className="w-full bg-black/5 p-3 rounded-2xl mb-3">
                    <Text className="text-xl font-bold text-black text-center"><Icon name="apple" color="black" size={30} />  Continue with Apple</Text>
                    </TouchableOpacity>
                </View>
